...
# ╔═╡ 914f8a32-9c43-4475-8969-9fc5f0c3f2a4
@htl("""
	<style>
	.cool-class {
		font-size: 1.3rem;
	...
	<div class="cool-class"> <i>What can we derive from that? </i></div>
	""")
...
begin
	...
	scatter(spline_x,spline_y,label="Spline Points",legend = :topleft)
	plot!(x,y, label="f")
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "e0ad346f02e33e7b0742644d85987e913cf4708d"
